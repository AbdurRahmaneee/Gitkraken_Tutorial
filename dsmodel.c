...
/* DSblock model generated by Dymola from Modelica model FM3217_2023.Tutorial3.Tests.DCGeneratorTest
 Dymola Version 2020 (64-bit), 2019-04-10 translated this at Fri Sep 22 00:25:29 2023
...
#define NHash1_ -372606851
#define NHash2_ -1626643317
#define NHash3_ 0
#define NI_    0
#define NRelF_ 0
#define NRel_  0
...
PreNonAliasDef(5)
#if !defined(DYM2CCUR)
 DYMOLA_STATIC const char*modelName="FM3217_2023.Tutorial3.Tests.DCGeneratorTest";
#endif
...
DYNX(W_,14) = DYNX(DP_,5);
DYNX(W_,30) = DYNX(DP_,6);
...
SolveScalarLinearParametric(DYNX(DP_,7)+DYNX(W_,30),"inertia.J+dCMachine.inertia.J",
   DYNX(DP_,8),"constantTorque.tau_constant", DYNX(F_,1),"der(inertia.w)");
DYNX(W_,32) = DYNX(W_,30)*DYNX(F_,1);
...
DYNX(W_,33) = DYNX(DP_,3)*DYNX(X_,1);
...
DeclareAlias2("dCMachine.inertia.flange_b.tau", "Cut torque in the flange [N.m]",\
 "dCMachine.flange.tau", 1, 5, 32, 132)
...
0.0,0.0,0.0,0,777)
DeclareParameter("dCMachine.L", "Inductance of the DC Machine [H]", 5, 0.1, \
0.0,0.0,0.0,0,560)
DeclareParameter("dCMachine.J", "Internal inertia of the DC machine [kg.m2]", 6,\
...
"constantTorque.tau_constant", 1, 7, 8, 132)
DeclareParameter("inertia.J", "Moment of inertia [kg.m2]", 7, 1, 0.0,1E+100,0.0,\
0,560)
...
DeclareAlias2("constantTorque.tau", "Accelerating torque acting at flange (= -flange.tau) [N.m]",\
 "constantTorque.tau_constant", 1, 7, 8, 0)
EndNonAlias(0)
